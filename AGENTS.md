...
Full inventory — 16 workspaces, 30 collections, root source and sync status for each — in
`postman/collections/INVENTORY.md`. Scope is defined by the `WORKSPACES` array in the HTML of
https://opencollections.tech/.

Projects with their own multi-version workflow:
